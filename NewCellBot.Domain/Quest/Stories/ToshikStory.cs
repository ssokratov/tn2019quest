...
{
    public static class ToshikStory
    {
        ...
        public static DialogQuestion[] GetDialogs()
        {
            ...
            var mapDialog = new DialogQuestion
            {
                ...
                Answers = new[] {
                    new DialogAnswer {
                        ...
                        MoveToDialog = Dialog.InventoryToshik,
                    },
                    new DialogAnswer {
                    ...
                    new DialogAnswer {
                        ...
                        MoveToDialog = Dialog.JournalToshik,
                    },
                    new DialogAnswer {
                    ...
                    new DialogAnswer {
                        Available = (i, j) => j.IsFinished(Bot.Quest.EnterHall) && !j.IsOpen(Bot.Quest.Kolyan),
                        Message = $"{MapIcon.Toshik.ToSmile()} идти к...",
                    ...
                    new DialogAnswer {
                        Available = (i, j) => j.IsOpen(Bot.Quest.Demianov),
            ...
            var moveToDialog = new DialogQuestion
            {
                ...
                Answers = new[] {
                    ...
                    new DialogAnswer {
                        Message = "К Сократу",
                        Available = (i, j) => !j.IsOpen(Bot.Quest.FireAlarm),
                ...
                DynamicMessage = (i, j) => {
                    return "*Инвентарь*:\n"
                           ...
                           + (i.Has(Item.FireExtinguisher)
                               ? $"{MapIcon.FireExtinguisher.ToSmile()} огнетушитель\n"
                               : "")
            ...
            var journalDialog = new DialogQuestion
            {
                ...
                DynamicMessage = (i, j) => {
                    ...
                    return "*Журнал*:\n"
                           + RenderQuest(Bot.Quest.EnterHall, "Войти в зал")
                           + RenderQuest(Bot.Quest.AskForWedding, "Поговорить с работником ЗАГСа")
                           + RenderQuest(Bot.Quest.Demianov, "Позвонить Демьянову")
                           + RenderQuest(Bot.Quest.Jacob, "Замутить Якову телефон")
                           + RenderQuest(Bot.Quest.Sedosh, "Обсчитать проект капитанской хижины")
                           + RenderQuest(Bot.Quest.Kolyan, "Код КРАКОВ!")
                           + RenderQuest(Bot.Quest.KolyanDachaOpenDoor, "Открыть дверь дачного домика")
                           + RenderQuest(Bot.Quest.FireAlarm, "Потушить пожар")
                           + RenderQuest(Bot.Quest.Sokrat, "Починить Сократу роутер")
                           + RenderQuest(Bot.Quest.DressForWedding, "Приодеться к свадьбе")
                        ;
                },
                Answers = new[] {
                    new DialogAnswer {
            ...
            var veilDialogs = new[] {
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            ...
                            ChangeMap = (pos, map) => map.ClearPos(pos),
                            ChangeJournal = j => j.Finish(Bot.Quest.EnterHall).Open(Bot.Quest.AskForWedding)
                        },
                        new DialogAnswer {
                            Message = "Перешагнуть",
                ...
                new DialogQuestion {
                    ...
                    Message =
                        "В зале собрались гости, все очень рады вас видеть. Пожалуй, стоит поговорить с работницей ЗАГСа насчет начала церемонии.",
                    Answers = mapDialog.Answers,
                    DisplayMap = true
                },
            };
                ...
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            ...
                            ChangeJournal = j => j.Finish(Bot.Quest.Demianov),
                            MoveToDialog = Dialog.MapToshik
                        },
                    }
                },
            ...
            var kolyanDialogs = new[] {
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        ...
                        new DialogAnswer {
                            Message = "WTF?!?!?!",
                            Available = (i, j) => j.IsFinished(Bot.Quest.Kolyan) && !i.Has(Item.Boots),
                ...
                new DialogQuestion {
                    Name = Dialog.Kolyan2,
                    Message =
                        "_Колян:_ Слушай, у меня тут авария произошла. Только что Ромыч позвонил и сказал, что у нас на даче" +
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            Message = "Поехали",
                            ChangeJournal = j => j.Open(Bot.Quest.Kolyan),
                ...
                new DialogQuestion {
                    Name = Dialog.Kolyan4,
                    Message =
                        "По дороге вы заезжаете на УНЦ за ключами от дачи, затем по пути отвозите некоторые документы " +
                ...
                new DialogQuestion {
                    Name = Dialog.Kolyan5,
                    Message =
                        "_Колян_: О, ты уже вернулся! Норм. Сорян, мне пришлось срочно уехать на распродажу обуви в Ельцин центр." +
                ...
                new DialogQuestion {
                    ...
                    Message =
                        "_Колян_: блин, не могу найти ключи. Либо я их вместе с документами случайно отдал, либо где-то" +
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            ...
                            MoveToPos = (pos, map) => map.PosLeft(MapIcon.KolyanDacha),
                            ChangeMap = (pos, map) =>
                                map.Replace(map.PosLeft(map.PosLeft(map.PosUp(MapIcon.KolyanDacha))),
                ...
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            ...
                            ChangeMap = (pos, map) =>
                                map.Replace(map.PosLeft(map.PosLeft(map.PosUp(MapIcon.KolyanDacha))), MapIcon.Empty)
                        },
                    },
                ...
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            ...
                            ChangeJournal = j => j.Open(Bot.Quest.KolyanDachaOpenDoor)
                        }
                    }
                },
                new DialogQuestion {
                ...
                new DialogQuestion {
                    ...
                    Message =
                        "Через 20 минут стараний вы понимаете, что дверь открыть не получится. Колян так и не вернулся, " +
            ...
            var sedoshDiagogs = new[] {
                ...
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            Available = (i, j) => !j.IsOpen(Bot.Quest.Sedosh),
                            Message = "Пообещать помочь",
                            MoveToDialog = Dialog.MapToshik,
                            ChangeJournal = j => j.Open(Bot.Quest.Sedosh),
                            MoveToPos = (pos, map) => map.PosRight(MapIcon.Sedosh)
                        },
                        new DialogAnswer {
                            Available = (i, j) => i.Has(Item.Project),
                ...
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            ...
                            ChangeJournal = j => j.Finish(Bot.Quest.Sedosh),
                            MoveToPos = (pos, map) => map.PosRight(MapIcon.Sedosh)
                        },
                    }
                },
                ...
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            ...
                            ChangeJournal = j => j.Open(Bot.Quest.Jacob),
                ...
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            Message = "Пообещать помочь",
                            MoveToDialog = Dialog.MapToshik,
                            ChangeJournal = j => j.Open(Bot.Quest.Demianov),
                            MoveToPos = (pos, map) => map.PosRight(MapIcon.Jacob)
                        }
                    }
                },
                ...
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            ...
                            ChangeJournal = j => j.Finish(Bot.Quest.Jacob),
                            MoveToPos = (pos, map) => map.PosRight(MapIcon.Jacob)
                        }
                    }
                },
            ...
            var sokratDialogs = new[] {
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            Available = (i, j) => j.IsFinished(Bot.Quest.FireAlarm) && !j.IsKnown(Bot.Quest.Sokrat),
                            Message = "Сократ, что это было?!",
                            MoveToDialog = Dialog.Sokrat2
                        },
                        new DialogAnswer {
                            Available = (i, j) => j.IsOpen(Bot.Quest.Sokrat),
                ...
                new DialogQuestion {
                    Name = Dialog.Sokrat2,
                    Message =
                        "_Сократ:_ Сорян, чёт пригорел немного. Опять вайфай роутер не работает, я из-за этого катку в лолец слил!",
                    Answers = new[] {
                        new DialogAnswer {
                            ChangeJournal = j => j.Open(Bot.Quest.Sokrat),
                ...
                new DialogQuestion {
                    Name = Dialog.Sokrat3,
                    Message =
                        "_Сократ:_ Поможешь починить роутер? Я уже всё перепробовал. И молотком его бил, и об стену. Не помогает.",
                    Answers = new[] {
                        new DialogAnswer {
                ...
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            ...
                            ChangeJournal = j => j.Finish(Bot.Quest.Sokrat),
                            MoveToDialog = Dialog.MapToshik,
                            MoveToPos = (pos, map) => map.PosLeft(MapIcon.Sokrat)
                        },
                    },
            ...
            var zagsWorkerDialogs = new[] {
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            Message = "Поговорить",
                            Available = (i, j) => !j.IsFinished(Bot.Quest.DressForWedding),
                            ChangeJournal = j => j.Finish(Bot.Quest.AskForWedding).Open(Bot.Quest.DressForWedding),
                            MoveToDialog = Dialog.ZagsWorker2
                        },
                        new DialogAnswer {
                            Message = "Приодеться!",
                            Available = (i, j) =>
                                j.IsOpen(Bot.Quest.DressForWedding) && i.Has(Item.Boots) && i.Has(Item.Hat) &&
                                i.Has(Item.Glasses),
                ...
                new DialogQuestion {
                    ...
                    Answers = new[] {
                        new DialogAnswer {
                            Message = "Далее",
                            MoveToDialog = Dialog.ZagsEnd,
                            ChangeJournal = j => j.Finish(Bot.Quest.DressForWedding),
                        },
                    },
                },
                new DialogQuestion {
                    Name = Dialog.ZagsEnd,
                    Message = "Тем временем на другом конце города...",
                    Answers = new[] {
                        new DialogAnswer {
                            Message = "Далее",
            ...
            var randomDialogs = new[] {
                new DialogQuestion {
                    Name = Dialog.FoundWallToshik,
                    Message = "Уперся в стену",
                    Answers = mapDialog.Answers,
                    DisplayMap = true,
                    PreventMove = true,
                    MapIcon = MapIcon.WallToshik
                },
                new DialogQuestion {
